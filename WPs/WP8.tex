...
design and validate an innovative learning programme for delivery through the \TheProject{} MOOC. The MOOC will require planning, design and creation of content, guided by expertise from FutureLearn e.g.
\TheProject{} films with text transcripts for translation from English for participants across the EU. These will use the \TheProject{}
consortium resources and expertise, with inputs from international science and technology partners within the \TheProject{}
consortia and their networks on methods, protocols and guides for collaborative digital security experiments. 
...
\item \ref{del:dissemplan2} (Month 24): Second Interim Report on Dissemination \& Exploitation, including Exploitation Plan, Communication Activities, User Community Building, IPR Management, and Second Project Workshop and MOOC.
