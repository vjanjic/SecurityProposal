...
\item To apply the theories into industrialised solution as apply use cases.
\item Banking - Open Banking
\item Air Traffic Management - Flight Slot Management
\item Healthcare Solution
\end{compactitem}
\end{WPObjectives}
