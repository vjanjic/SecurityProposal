...
\begin{WPDeliverables}
  \begin{compactitem}
  \item \ref{del:auth1} (Month 9) : Report on Initial User Authentication Techniques for Data Analytics on Private Clouds
	\item \ref{del:auth2} (Month 22) : Software on Refined User Authentication Techniques for Data Analytics on Public Clouds
\item \ref{del:auth3} (Month 34) : Report on Final User Authentication Techniques for Data Analytics on Hybrid Clouds
\end{compactitem}
\end{WPDeliverables}
\end{Workpackage}
