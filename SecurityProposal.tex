...
Sopra-Steria Limited will supply a insight into the real-world case studies that we could use to prove the research is achieving the proposed outcomes.
...
\subsubsection*{Objective 1: Security Contracts for Formal Specification of Security Properties}
\vspace{-6pt}
