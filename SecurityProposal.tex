...
\begin{mdframed}[backgroundcolor=blue!5]
\textbf{Programming Languages Support.} \TheProject{} mainly targets big data analytics applications written in C++. C++ is heavily used in many of the infrastructures for  big data processing, including state-of-the-art distributed databases such as MongoDB and is known to deliver excellent performance on parallel hardware. Furthermore, two out of three use cases considered in the project are based on C++. However, taking into account popularity of Java and Python in big data analytics, majority of \TheProject{} tool-chain will target Java, and to a smaller extent Python too. The table below lists the languages that different technologies will support over the course of \TheProject{}.
