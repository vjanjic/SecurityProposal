...
\begin{itemize}
    ...
    \item It is also in the plans of \YAGshort{} to offer a source code scanning SAAS platform to the opensource community, that wil benefit from \TheProject technologies that will be integrated to YAG-Suite.
\end{itemize}
