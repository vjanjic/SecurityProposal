...
\textbf{Title of Proposal:} & \textbf{Intelligent Security and Privacy
                              Management} & \\[4ex] 
...
\subsubsection{University of St Andrews - Security Contracts}
\begin{itemize}
...
\end{itemize}
\subsubsection{University of Cyprus}
\begin{itemize}
...
\subsubsection{Sopra-Steria}

As a commercial partner we want to start investigation into the following areas:
\begin{itemize}
    \item Finance (open banking for CMA9) as data source for a universal banking solution that supports a secure banking interaction with appropiate trust and privacy as expected.
...
Sopra-Steria will supply a insight into the real-world case studies that we could use to prove the research is achieving the proposed outcomes.
...
\item[Aim 3:] To build additional security layers on top of the existing systems, based on novel secure authentication
  techniques;

\item[Aim 4:] To integrate the \TheProject{} tools and techniques into a coherent methodology for establishing
...
\item[Aim 5:]  To demonstrate the applicability of the \TheProject{} tools and
 ...
 baking domains and to promote their long-term uptake by building a sustainable user community,
...
\item[Objective 5:] To augment the existing security layer of distributed data analytics application with AI-driven
  behavioural authentication models, implementing Authentication-as-a-Service (AAAS) technology. \emph{This fulfils
    parts of \textbf{Aim 3} and \textbf{Aim 4}}.
...
\item WP5: AI-Driven Behavioural Authentication (COGNITIVE AX)
...
\subsubsection*{Objective 2: XX}
\vspace{-6pt}


\subsubsection*{Objective 3: XX}
\vspace{-6pt}

\subsubsection*{Objective 4: XX}
\vspace{-6pt}

\subsubsection*{Objective 5: XX}
\vspace{-6pt}

\subsubsection*{Objective 6: XX}
\vspace{-6pt}

\subsubsection*{Objective 7: XX}
...
different domains, 
including medical, aerospace and banking. 
\newline
