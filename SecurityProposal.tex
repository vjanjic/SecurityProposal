...
\begin{itemize}
    ...
    \item Space-based open Internet capabilities using low Earth orbit satellites and therefor using an open meshed network for communication. Investigate how Delay/Disruption Tolerant Networking (DTN) and Solar System Internet (SSI) will impact our communication security.
...
\item Integration in the C++ programming language of contracts in the form of preconditions, postconditions, invariants, \ldots
\item Identification and avoidance of software vulnerabilities (security and asafety) derived from programming language features 
...
\item[Aim 4:] To integrate the \TheProject{} tools and techniques into a coherent self-healing methodology for establishing
  security and privacy properties of the code and repairing any identified vulnerabilities and leakages, targetting both 
...
Objective 5 & Behavioural Authentication Models & \textbf{WP5} \\\hline
...
Objective 2 aims to develop novel techniques for repairing security vulnerabilities and data leakages in the C++ code. In WP4, we will develop techniques for repairing of the security vulnerabilities. These techniques will be based on XX, and their application will be under control of the end-user via semi-automated \emph{code refactoring}. In WP3, we will develop methods for optimal noise adding to control the leakage of sensitive data during building of machine-learning models, as well as the methods for secure knowledge exchange between machine-learning models and third parties. 
...
\subsubsection*{Relevant Research Projects, Products and Patents}
