...
\item Section 2.1 : Finish writing up the Impacts 
\begin{itemize}
...
\item Section 2.1 : Write up Barriers for Impact (UOD)

\item Section 2.1 : Finish the gender balance box (\sout{SCCH} and EVERYONE)
...
\item Section 2.3.3 : Write up KPIs for Dissemination and Communication (USTAN and UC3M)
...
\item Section 1.3.4: Add how this project goes beyond what is done in the previous ones \begin{itemize}
\item FRQ added text for SAPIENT and SINAPSE
