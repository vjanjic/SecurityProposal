...
\paragraph{How Will \TheProject{} Achieve This Impact:} Several technologies of \TheProject{} (e.g.~identity management, the intelligent user interface, and so on) will be designed and developed following a user-centered design approach with the active participation of software developers and end users, in such a way that evaluation feedback gathered through user studies will lead the development process. 
