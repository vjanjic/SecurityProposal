...
big data can be used to facilitate rapid scientific breakthroughs 
...
The \primal project, supported by the Austrian Research Promotion Agency, is concerned with the development of privacy-preserving machine learning industrial applications. The project focuses on the development of algorithms and a software framework for differentially private distributed deep learning, transfer learning, and multi-task learning with applications to industrial use cases. \emph{While the results of \primal regarding differential privacy in distributed machine learning has a synergy with the privacy theme of \TheProject{}, information theoretic approach to study and optimize privacy-leakage in distributed AI is one of the novelties of \TheProject{}}.
\end{mdframed}
