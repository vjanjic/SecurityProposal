...
\newline
They all face the same dilemna: from a very huge volume of the analyzesource code they must ideally warn the user on each and every potential vulnerabilities and only when a vulnerability is detected. 
