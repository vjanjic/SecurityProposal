...
\item GROW Observatory (GROW, SC5-17-2015, 690199, 2016-2019), \url{https://growobservatory.org}
...
\vspace{10pt}
\subsubsection*{Role in Elysian}
\textbf{IBM leads work package \ref{wp:vulnerability}  on Vulnerability Detection and Self-Healing. It also contributes to the development of privacy preserving ML models, formal verification of security, use cases evaluation and provides the Data Fabrication Platform to produce synthetic but realistic data for the project use cases.}
...
\paragraph{Andr\'eas Fran\,{c}ois Vermeulen} (male) Head of Analytics, Digital Consultancy Services within the United Kingdom.
