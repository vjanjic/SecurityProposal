...
%===============================================================================
\YAGlong{} is a french cyber security product editor dedicated at managing cyber risk in software applications. The YAG-Suite, the company's product, equips security and privacy by design development processes as well as source code audit service providers. The company was established in January 2017 under the status of Simplified Joint Stock Company with a capital of 85,000 Eur.

The YAG-Suite is a smart tool based on static analysis and machine learning to identify the vulnerability that matter in the source code of software applications. It supports the users to effectively detect security breaches and sensitive data protection breaches in an application, to understand their causes via detailed diagnostics, to identify the necessary and sufficient remediation actions as well as feeding managerial dashboards.The YAG-Suite supports the two phases vulnerability investigation processes:
\begin{itemize}
\item To equip code reviews and the "security and privacy by design" software development processes, the YAG-Suite offers automated scanning capabilities. Deployed on the developer's workstation, in continuous integration factory or in SAAS mode, the YAG-Suite comprehensively scans the source code of the project, without requiring that the project be "buildable", and without the need to document the code. 
...
\vspace{10pt}
\textbf{ \YAGlong{} participates in WPXX on XX.}
