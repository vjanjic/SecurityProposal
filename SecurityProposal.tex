...
\begin{itemize}
    ...
    \item Build prototype ecosystem with ARM Ethos-N77, SC300 and SC000 base cloud to test Delay/Disruption Tolerant Networking (DTN) between robots (Pelion IoT Platform) to simulate the use cases
\end{itemize}
...
\jbcomment{JB:There is a slight disconnect above between data and code (that processes and/or generates data) - needs to be made clearer, as we address both. Code is only mentioned in the final two sentences...}
